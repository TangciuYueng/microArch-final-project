...
public class DiaryEmotionServiceImpl implements DiaryEmotionService {
    ...
    private DiaryEmotion convertToEntity(DiaryEmotionDTO diaryEmotionDTO) {
        ...
        diaryEmotion.setHappy(diaryEmotionDTO.getHappy());
        diaryEmotion.setSad(diaryEmotionDTO.getSad());
        diaryEmotion.setAggressive(diaryEmotionDTO.getAggressive());
        diaryEmotion.setPeace(diaryEmotionDTO.getPeace());
        return diaryEmotion;
    }
